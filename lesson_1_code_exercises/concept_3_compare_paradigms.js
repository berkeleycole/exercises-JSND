...
// Since this is an object oriented program, we know that we will be working with a class
class WarpDrive {
...
let enterprise_warp = new WarpDrive('Dilithium Chrystal', 'Starfleet Command')

// NOTE: This is a big win for the object oriented style - it is so easy to make multiple instances of WarpDrive
// Our program could simulataneously reference as many warp drive as instances as we want -- how would you do that in the imperative program?
